...
extern SEXP _kentr_get_hamming_pairs(SEXP, SEXP);
extern SEXP _kentr_get_kmers(SEXP, SEXP);
extern SEXP _kentr_getSeq(SEXP, SEXP);
extern SEXP _kentr_read_bam(SEXP, SEXP, SEXP);
extern SEXP _kentr_read_bam_tags(SEXP, SEXP, SEXP);
